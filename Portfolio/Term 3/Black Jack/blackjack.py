# Jared M.
# 2/15/2019
# Blackjack from 1 to 7 players to compete with dealer
    ...
    def total(self):
        ...
        for card in self.cards:
            if card.value == BJ_Card.ACE_VALUE:
                contains_ace = True
        #if hand contains Ace and the total is low enough, treat Ace as 11
...
class BJ_Game(object):
    def __init__(self, names):
        ...
        self.dealer = BJ_Dealer("Dealer: Jimmy Jhonny")
